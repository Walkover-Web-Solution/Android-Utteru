...
import com.Utteru.R;
import com.Utteru.adapters.SearchListAdapter;
...
public class SearchListActivity extends BaseActivity {
    ...
    protected void onStart() {
        listadapter = new SearchListAdapter(country_list, ctx);
    ...
    protected void onResume() {
        searchFontTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                listview.setAdapter(new SearchListAdapter(filterList1, ctx));
            }
    ...
    public void finish() {
        Log.e("onfinsh", "on finish");
            ...
            data.putExtra(VariableClass.Vari.COUNTRYISO, countryIso);
