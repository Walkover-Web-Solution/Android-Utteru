 ...
 */
public class CustomKeyboardSearchRate {
    ...
    private OnKeyboardActionListener mOnKeyboardActionListener = new OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            if (focusCurrent.getClass() != AutoCompleteTextView.class) {
                // Do something for froyo and above versions

                if (focusCurrent == null || focusCurrent.getClass() != AutoCompleteTextView.class) return;
            } else {
            ...
            AutoCompleteTextView edittext = (AutoCompleteTextView) focusCurrent;
            ...
            if (primaryCode == CodeCancel) {
                ...
                if (isNumpad)
                    initNumKeypad(R.xml.numberic_keypad_other);
                else
                    initAlphaKeypad(R.xml.alpha_keypad_other);
     ...
     */
    public CustomKeyboardSearchRate(Activity host, int viewid, int layoutid, View getview) {
        mHostActivity = host;
        view = viewid;
        layout = layoutid;
        ...
        if (getview == null)
            ...
            mKeyboardView = (KeyboardView) getview.findViewById(viewid);
    ...
    public void registerEditText(int resid,View getview) {
        ...
        if(getview==null) {
            ...
            edittext = (AutoCompleteTextView) mHostActivity.findViewById(resid);
        }

        else {
            edittext = (AutoCompleteTextView) getview.findViewById(resid);
        }
